...
public class StatusBarUtil {
    ...
    /**
     * 改变状态栏文字颜色,状态栏浮在View上方
     *
     * @param activity
     * @param dark
     */
    @RequiresApi(api = Build.VERSION_CODES.M)
    public static void setAndroidNativeLightStatusBarFullscreen(Activity activity, boolean dark) {
        View decor = activity.getWindow().getDecorView();
        if (dark) {
    ...
    public static boolean MIUISetStatusBarLightMode(Activity activity, boolean dark) {
        ...
        if (window != null) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && MyRomUtils.isMiUIV7OrAbove()) {
